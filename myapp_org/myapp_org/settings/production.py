...
STATIC_ROOT = '/var/www/myapp_org/static'
MEDIA_ROOT = '/var/www/myapp_org/media'
...
#ALLOWED_HOSTS = ['localhost', '*.pagekite.me', 'myapp.org', 'www.myapp.org' ]
ALLOWED_HOSTS = ['beta.myapp.org', 'myapp.org', 'www.myapp.org' ]
